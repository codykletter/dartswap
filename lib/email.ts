...
export async function sendPasswordResetEmail(
  ...
  try {
    ...
    const mailOptions = {
      from: `"DartSwap" <${fromEmail}>`,
      to: email,
      subject: 'Reset your DartSwap password',
      html: `
        <!DOCTYPE html>
        <html>
          <head>
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                ...
                <p style="word-break: break-all; color: #00693e;">${resetUrl}</p>
                <p style="margin-top: 20px; color: #666; font-size: 14px;">This link will expire in 1 hour.</p>
                <p style="margin-top: 20px;">If you didn't request a password reset, please ignore this email. Your password will remain unchanged.</p>
              </div>
              <div class="footer">
                <p>This is an automated message. Please do not reply to this email.</p>
                <p>&copy; ${new Date().getFullYear()} DartSwap. All rights reserved.</p>
